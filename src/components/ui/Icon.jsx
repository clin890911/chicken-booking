...
const PATHS = {
  ...
  today: <><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M3 10h18" /><path d="M8 3v4" /><path d="M16 3v4" /><path d="M9 15l2 2 4-4" /></>,
  ...
  clockSettings: <><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></>,
  globe: <><circle cx="12" cy="12" r="9" /><path d="M3 12h18" /><path d="M12 3a14 14 0 0 1 0 18" /><path d="M12 3a14 14 0 0 0 0 18" /></>,
  bell: <><path d="M6 16V11a6 6 0 0 1 12 0v5l2 2H4z" /><path d="M10 21a2 2 0 0 0 4 0" /></>,
  lock: <><rect x="5" y="11" width="14" height="10" rx="2" /><path d="M8 11V7a4 4 0 0 1 8 0v4" /></>,
  paw: <><circle cx="8" cy="8" r="1.8" /><circle cx="16" cy="8" r="1.8" /><circle cx="5" cy="13" r="1.6" /><circle cx="19" cy="13" r="1.6" /><path d="M12 12c-2.5 0-5 2.5-5 4.5A2.5 2.5 0 0 0 9.5 19h5a2.5 2.5 0 0 0 2.5-2.5c0-2-2.5-4.5-5-4.5z" /></>,
  wrench: <><path d="M14.5 5.5a4 4 0 0 0 5 5l-9 9a2.1 2.1 0 0 1-3-3l9-9z" /><path d="M14.5 5.5l4 4" /></>,
  ...
  inbox: <><path d="M4 13l2-8h12l2 8v6H4z" /><path d="M4 13h5l1.5 2h3L15 13h5" /></>,
  hourglass: <><path d="M6 3h12" /><path d="M6 21h12" /><path d="M8 3v4l4 5-4 5v4" /><path d="M16 3v4l-4 5 4 5v4" /></>,
  pointer: <><path d="M5 3l14 8-6 2-2 6z" /></>,
  layout: <><rect x="3" y="4" width="18" height="16" rx="2" /><path d="M3 10h18" /><path d="M10 10v10" /></>,
  traffic: <><rect x="8" y="2" width="8" height="20" rx="3" /><circle cx="12" cy="6.5" r="1.6" /><circle cx="12" cy="12" r="1.6" /><circle cx="12" cy="17.5" r="1.6" /></>,
  ...
  medal: <><circle cx="12" cy="15" r="5" /><path d="M8.5 10.5L6 3h4l2 5 2-5h4l-2.5 7.5" /></>,
  chair: <><path d="M5 10h14v11" /><path d="M5 10V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v6" /><path d="M5 21v-6" /><path d="M5 15h14" /></>,
  mark: <><path d="M12 21s-6-5.5-6-10a6 6 0 0 1 12 0c0 4.5-6 10-6 10z" /><circle cx="12" cy="11" r="2" /></>,
