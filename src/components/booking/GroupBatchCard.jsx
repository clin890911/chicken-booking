...
// React.memo：與 BookingCard 同理，清單重繪時 props 沒變就跳過。
const STATUS_LABEL = {
...
function GroupBatchCard({ group, batch, onOpen }) {
  ...
  return (
    <button
      ...
      className="tap w-full text-left rounded-xl border-2 border-indigo-200 bg-indigo-50/60 p-3.5 hover:border-indigo-400 transition-colors"
    >
...
export default memo(GroupBatchCard)
